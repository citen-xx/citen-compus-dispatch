...
-- ----------------------------
-- Table structure for tb_resource_quota
-- ----------------------------
DROP TABLE IF EXISTS `tb_resource_quota`;
CREATE TABLE `tb_resource_quota`  (
  `resource_id` bigint(20) UNSIGNED NOT NULL COMMENT '关联资源id',
  `quota` int(8) NOT NULL COMMENT '可预约额度',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `tb_lab`  (
  ...
  `lab_type_id` bigint(20) UNSIGNED NOT NULL COMMENT '商铺类型的id',
...
-- ----------------------------
-- Records of tb_lab_type
-- ----------------------------
INSERT INTO `tb_lab_type` VALUES (1, '美食', '/types/ms.png', 1, '2021-12-22 20:17:47', '2021-12-23 11:24:31');
INSERT INTO `tb_lab_type` VALUES (2, 'KTV', '/types/KTV.png', 2, '2021-12-22 20:18:27', '2021-12-23 11:24:31');
INSERT INTO `tb_lab_type` VALUES (3, '丽人·美发', '/types/lrmf.png', 3, '2021-12-22 20:18:48', '2021-12-23 11:24:31');
INSERT INTO `tb_lab_type` VALUES (4, '健身运动', '/types/jsyd.png', 10, '2021-12-22 20:19:04', '2021-12-23 11:24:31');
INSERT INTO `tb_lab_type` VALUES (5, '按摩·足疗', '/types/amzl.png', 5, '2021-12-22 20:19:27', '2021-12-23 11:24:31');
INSERT INTO `tb_lab_type` VALUES (6, '美容SPA', '/types/spa.png', 6, '2021-12-22 20:19:35', '2021-12-23 11:24:31');
INSERT INTO `tb_lab_type` VALUES (7, '亲子游乐', '/types/qzyl.png', 7, '2021-12-22 20:19:53', '2021-12-23 11:24:31');
INSERT INTO `tb_lab_type` VALUES (8, '酒吧', '/types/jiuba.png', 8, '2021-12-22 20:20:02', '2021-12-23 11:24:31');
INSERT INTO `tb_lab_type` VALUES (9, '轰趴馆', '/types/hpg.png', 9, '2021-12-22 20:20:08', '2021-12-23 11:24:31');
INSERT INTO `tb_lab_type` VALUES (10, '美睫·美甲', '/types/mjmj.png', 4, '2021-12-22 20:21:46', '2021-12-23 11:24:31');
...
CREATE TABLE `tb_resource`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `lab_id` bigint(20) UNSIGNED NULL DEFAULT NULL COMMENT '实训室/算力中心id',
  ...
  `usage_rules` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '使用规则',
  `reserve_value` bigint(10) UNSIGNED NOT NULL COMMENT '预约占用值',
  `confirm_value` bigint(10) NOT NULL COMMENT '签到确认值',
  `resource_mode` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-普通资源；1-稀缺资源',
...
CREATE TABLE `tb_reservation`  (
  ...
  `resource_id` bigint(20) UNSIGNED NOT NULL COMMENT '预约的资源id',
  `reserve_type` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '预约方式 1：在线预约；2：管理员代约；3：系统调度',
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '订单状态，1：未支付；2：已支付；3：已核销；4：已取消；5：退款中；6：已退款',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '下单时间',
  `confirm_time` timestamp NULL DEFAULT NULL COMMENT '签到确认时间',
  `complete_time` timestamp NULL DEFAULT NULL COMMENT '预约完成时间',
  `cancel_time` timestamp NULL DEFAULT NULL COMMENT '预约取消时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
